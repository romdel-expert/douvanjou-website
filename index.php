...
<html lang="fr">
  <head>
    ...
    <title>Association DOUVANJOU</title>
  </head>
  <body>
    ...
    <main>
        <?php include('./assets/page/home.php'); ?>
        <?php //include('./assets/page/subscribe.php'); ?>
        <?php //include('./assets/page/form_given.php'); ?>
        <?php //include('./assets/page/contact.php'); ?>
    </main>
